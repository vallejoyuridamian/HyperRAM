...
-- ldbanno -n VHDL -o HyperRAM_hyperram_mapvho.vho -w -neg -gui -msgset C:/Users/Damian/Desktop/Upwork/CamilaFPGA/Project/promote.xml HyperRAM_hyperram_map.ncd 
-- Netlist created on Sun Jul 03 23:38:38 2022
-- Netlist written on Sun Jul 03 23:38:44 2022
...
-- entity clk_out_testB
  ...
  begin
    clk_out_test_pad: sapiobuf0003
      port map (I=>GNDI, T=>VCCI, PAD=>clkouttest_out);
    DRIVEGND: gnd
      port map (PWR0=>GNDI);
    DRIVEVCC: vcc
      port map (PWR1=>VCCI);
    ...
    VitalBehavior : PROCESS (clkouttest_out)
...
-- entity hyperram_tb
  ...
  architecture Structure of hyperram_tb is
    ...
    signal uut_DQ_31_N_77: Std_logic;
    ...
    signal uut_n446: Std_logic;
    signal uut_n444: Std_logic;
    ...
    signal CK_LVDS_N_123: Std_logic;
    signal n448: Std_logic;
    signal estado_test_c: Std_logic;
    signal VCC_net_000_BUF1: Std_logic;
    signal uut_state_N_81: Std_logic;
    signal uut_n447: Std_logic;
    signal uut_DQ_4_N_58: Std_logic;
    signal uut_clk_system_N_71_enable_3: Std_logic;
    signal uut_n392: Std_logic;
    signal uut_n350: Std_logic;
    signal uut_n262: Std_logic;
    signal uut_n358: Std_logic;
  ...
  begin
    uut_SLICE_0I: SLOGICB
      generic map (M0MUX=>"SIG", M1MUX=>"SIG", CLKMUX=>"INV", CEMUX=>"VHI", 
                   ...
                   CHECK_LSR=>TRUE)
      port map (M1=>DQ_test_out_1, FXA=>'X', FXB=>'X', A1=>'X', B1=>'X', 
                C1=>'X', D1=>'X', DI1=>'X', DI0=>'X', A0=>'X', B0=>'X', 
                C0=>'X', D0=>'X', M0=>DQ_test_out_0, CE=>'X', 
                CLK=>clk_in_test_c, LSR=>uut_DQ_31_N_77, OFX1=>open, F1=>open, 
                Q1=>DQ_31_N_3_1, OFX0=>open, F0=>open, Q0=>DQ_31_N_3_0);
    uut_SLICE_1I: SLOGICB
      generic map (M0MUX=>"SIG", M1MUX=>"SIG", CLKMUX=>"INV", CEMUX=>"VHI", 
                   LSRMUX=>"SIG", CHECK_M1=>TRUE, CHECK_M0=>TRUE, 
                   CHECK_LSR=>TRUE)
      port map (M1=>DQ_test_out_3, FXA=>'X', FXB=>'X', A1=>'X', B1=>'X', 
                C1=>'X', D1=>'X', DI1=>'X', DI0=>'X', A0=>'X', B0=>'X', 
                C0=>'X', D0=>'X', M0=>DQ_test_out_2, CE=>'X', 
                CLK=>clk_in_test_c, LSR=>uut_DQ_31_N_77, OFX1=>open, F1=>open, 
                Q1=>DQ_31_N_3_3, OFX0=>open, F0=>open, Q0=>DQ_31_N_3_2);
    uut_SLICE_2I: SLOGICB
      ...
      port map (M1=>'X', FXA=>'X', FXB=>'X', A1=>'X', B1=>'X', C1=>'X', 
                ...
                D0=>'X', M0=>DQ_test_out_4, CE=>'X', CLK=>clk_in_test_c, 
                LSR=>uut_DQ_31_N_77, OFX1=>open, F1=>open, Q1=>open, 
                OFX0=>open, F0=>open, Q0=>DQ_31_N_3_4);
    uut_SLICE_3I: SLOGICB
      generic map (CLKMUX=>"INV", CEMUX=>"VHI", SRMODE=>"ASYNC", 
                   LUT0_INITVAL=>X"DFD0", LUT1_INITVAL=>X"DFD0", 
                   REG1_SD=>"VHI", REG0_SD=>"VHI", CHECK_DI1=>TRUE, 
                   CHECK_DI0=>TRUE)
      port map (M1=>'X', FXA=>'X', FXB=>'X', A1=>uut_n444, B1=>uut_n446, 
                C1=>uut_DQ_31_N_77, D1=>DQ_test_out_6, DI1=>uut_DQ_31_N_110, 
                DI0=>uut_DQ_31_N_111, A0=>uut_n444, B0=>uut_n446, 
                C0=>uut_DQ_31_N_77, D0=>DQ_test_out_5, M0=>'X', CE=>'X', 
                CLK=>clk_in_test_c, LSR=>'X', OFX1=>open, F1=>uut_DQ_31_N_110, 
                Q1=>DQ_31_N_3_6, OFX0=>open, F0=>uut_DQ_31_N_111, 
                Q0=>DQ_31_N_3_5);
    uut_SLICE_4I: SLOGICB
      generic map (CLKMUX=>"INV", CEMUX=>"VHI", SRMODE=>"ASYNC", 
                   LUT0_INITVAL=>X"DFD0", REG0_SD=>"VHI", CHECK_DI0=>TRUE)
      port map (M1=>'X', FXA=>'X', FXB=>'X', A1=>'X', B1=>'X', C1=>'X', 
                D1=>'X', DI1=>'X', DI0=>uut_DQ_31_N_109, A0=>uut_n444, 
                B0=>uut_n446, C0=>uut_DQ_31_N_77, D0=>DQ_test_out_7, M0=>'X', 
                CE=>'X', CLK=>clk_in_test_c, LSR=>'X', OFX1=>open, F1=>open, 
                Q1=>open, OFX0=>open, F0=>uut_DQ_31_N_109, Q0=>DQ_31_N_3_7);
    uut_SLICE_5I: SLOGICB
      generic map (M0MUX=>"SIG", M1MUX=>"SIG", CLKMUX=>"INV", CEMUX=>"VHI", 
                   LSRMUX=>"SIG", CHECK_M1=>TRUE, CHECK_M0=>TRUE, 
                   CHECK_LSR=>TRUE)
      port map (M1=>DQ_test_out_9, FXA=>'X', FXB=>'X', A1=>'X', B1=>'X', 
                C1=>'X', D1=>'X', DI1=>'X', DI0=>'X', A0=>'X', B0=>'X', 
                C0=>'X', D0=>'X', M0=>DQ_test_out_8, CE=>'X', 
                CLK=>clk_in_test_c, LSR=>uut_DQ_31_N_77, OFX1=>open, F1=>open, 
                Q1=>DQ_31_N_3_9, OFX0=>open, F0=>open, Q0=>DQ_31_N_3_8);
    uut_SLICE_6I: SLOGICB
      generic map (M0MUX=>"SIG", M1MUX=>"SIG", CLKMUX=>"INV", CEMUX=>"VHI", 
                   LSRMUX=>"SIG", CHECK_M1=>TRUE, CHECK_M0=>TRUE, 
                   CHECK_LSR=>TRUE)
      port map (M1=>DQ_test_out_11, FXA=>'X', FXB=>'X', A1=>'X', B1=>'X', 
                C1=>'X', D1=>'X', DI1=>'X', DI0=>'X', A0=>'X', B0=>'X', 
                C0=>'X', D0=>'X', M0=>DQ_test_out_10, CE=>'X', 
                CLK=>clk_in_test_c, LSR=>uut_DQ_31_N_77, OFX1=>open, F1=>open, 
                Q1=>DQ_31_N_3_11, OFX0=>open, F0=>open, Q0=>DQ_31_N_3_10);
    uut_SLICE_7I: SLOGICB
      generic map (M0MUX=>"SIG", CLKMUX=>"INV", CEMUX=>"VHI", LSRMUX=>"SIG", 
                   CHECK_M0=>TRUE, CHECK_LSR=>TRUE)
      port map (M1=>'X', FXA=>'X', FXB=>'X', A1=>'X', B1=>'X', C1=>'X', 
                D1=>'X', DI1=>'X', DI0=>'X', A0=>'X', B0=>'X', C0=>'X', 
                D0=>'X', M0=>DQ_test_out_12, CE=>'X', CLK=>clk_in_test_c, 
                LSR=>uut_DQ_31_N_77, OFX1=>open, F1=>open, Q1=>open, 
                OFX0=>open, F0=>open, Q0=>DQ_31_N_3_12);
    uut_SLICE_8I: SLOGICB
      generic map (CLKMUX=>"INV", CEMUX=>"VHI", SRMODE=>"ASYNC", 
                   ...
                   CHECK_DI0=>TRUE)
      port map (M1=>'X', FXA=>'X', FXB=>'X', A1=>uut_n444, B1=>uut_n446, 
                C1=>uut_DQ_31_N_77, D1=>DQ_test_out_14, DI1=>uut_DQ_31_N_102, 
                DI0=>uut_DQ_31_N_103, A0=>uut_n444, B0=>uut_n446, 
                C0=>uut_DQ_31_N_77, D0=>DQ_test_out_13, M0=>'X', CE=>'X', 
                CLK=>clk_in_test_c, LSR=>'X', OFX1=>open, F1=>uut_DQ_31_N_102, 
                Q1=>DQ_31_N_3_14, OFX0=>open, F0=>uut_DQ_31_N_103, 
                Q0=>DQ_31_N_3_13);
    uut_SLICE_9I: SLOGICB
      generic map (CLKMUX=>"INV", CEMUX=>"VHI", SRMODE=>"ASYNC", 
                   LUT0_INITVAL=>X"DFD0", LUT1_INITVAL=>X"8888", 
                   REG0_SD=>"VHI", CHECK_DI0=>TRUE)
      port map (M1=>'X', FXA=>'X', FXB=>'X', A1=>uut_byte_counter_1, 
                B1=>uut_byte_counter_2, C1=>'X', D1=>'X', DI1=>'X', 
                DI0=>uut_DQ_31_N_101, A0=>uut_n444, B0=>uut_n446, 
                C0=>uut_DQ_31_N_77, D0=>DQ_test_out_15, M0=>'X', CE=>'X', 
                CLK=>clk_in_test_c, LSR=>'X', OFX1=>open, F1=>uut_n446, 
                Q1=>open, OFX0=>open, F0=>uut_DQ_31_N_101, Q0=>DQ_31_N_3_15);
    uut_SLICE_10I: SLOGICB
      generic map (M0MUX=>"SIG", M1MUX=>"SIG", CLKMUX=>"INV", CEMUX=>"VHI", 
                   LSRMUX=>"SIG", CHECK_M1=>TRUE, CHECK_M0=>TRUE, 
                   CHECK_LSR=>TRUE)
      port map (M1=>DQ_test_out_17, FXA=>'X', FXB=>'X', A1=>'X', B1=>'X', 
                C1=>'X', D1=>'X', DI1=>'X', DI0=>'X', A0=>'X', B0=>'X', 
                C0=>'X', D0=>'X', M0=>DQ_test_out_16, CE=>'X', 
                CLK=>clk_in_test_c, LSR=>uut_DQ_31_N_77, OFX1=>open, F1=>open, 
                Q1=>DQ_31_N_3_17, OFX0=>open, F0=>open, Q0=>DQ_31_N_3_16);
    uut_SLICE_11I: SLOGICB
      generic map (M0MUX=>"SIG", M1MUX=>"SIG", CLKMUX=>"INV", CEMUX=>"VHI", 
                   LSRMUX=>"SIG", CHECK_M1=>TRUE, CHECK_M0=>TRUE, 
                   CHECK_LSR=>TRUE)
      port map (M1=>DQ_test_out_19, FXA=>'X', FXB=>'X', A1=>'X', B1=>'X', 
                C1=>'X', D1=>'X', DI1=>'X', DI0=>'X', A0=>'X', B0=>'X', 
                C0=>'X', D0=>'X', M0=>DQ_test_out_18, CE=>'X', 
                CLK=>clk_in_test_c, LSR=>uut_DQ_31_N_77, OFX1=>open, F1=>open, 
                Q1=>DQ_31_N_3_19, OFX0=>open, F0=>open, Q0=>DQ_31_N_3_18);
    uut_SLICE_12I: SLOGICB
      generic map (M0MUX=>"SIG", CLKMUX=>"INV", CEMUX=>"VHI", LSRMUX=>"SIG", 
                   CHECK_M0=>TRUE, CHECK_LSR=>TRUE)
      port map (M1=>'X', FXA=>'X', FXB=>'X', A1=>'X', B1=>'X', C1=>'X', 
                D1=>'X', DI1=>'X', DI0=>'X', A0=>'X', B0=>'X', C0=>'X', 
                D0=>'X', M0=>DQ_test_out_20, CE=>'X', CLK=>clk_in_test_c, 
                LSR=>uut_DQ_31_N_77, OFX1=>open, F1=>open, Q1=>open, 
                OFX0=>open, F0=>open, Q0=>DQ_31_N_3_20);
    uut_SLICE_13I: SLOGICB
      generic map (CLKMUX=>"INV", CEMUX=>"VHI", SRMODE=>"ASYNC", 
                   ...
                   CHECK_DI0=>TRUE)
      port map (M1=>'X', FXA=>'X', FXB=>'X', A1=>uut_n444, B1=>uut_n446, 
                C1=>uut_DQ_31_N_77, D1=>DQ_test_out_22, DI1=>uut_DQ_31_N_94, 
                DI0=>uut_DQ_31_N_95, A0=>uut_n444, B0=>uut_n446, 
                C0=>uut_DQ_31_N_77, D0=>DQ_test_out_21, M0=>'X', CE=>'X', 
                CLK=>clk_in_test_c, LSR=>'X', OFX1=>open, F1=>uut_DQ_31_N_94, 
                Q1=>DQ_31_N_3_22, OFX0=>open, F0=>uut_DQ_31_N_95, 
                Q0=>DQ_31_N_3_21);
    uut_SLICE_14I: SLOGICB
      generic map (CLKMUX=>"INV", CEMUX=>"VHI", SRMODE=>"ASYNC", 
                   LUT0_INITVAL=>X"DFD0", LUT1_INITVAL=>X"007F", 
                   REG0_SD=>"VHI", CHECK_DI0=>TRUE)
      port map (M1=>'X', FXA=>'X', FXB=>'X', A1=>uut_byte_counter_2, 
                B1=>uut_byte_counter_1, C1=>uut_byte_counter_0, D1=>state, 
                DI1=>'X', DI0=>uut_DQ_31_N_93, A0=>uut_n444, B0=>uut_n446, 
                C0=>uut_DQ_31_N_77, D0=>DQ_test_out_23, M0=>'X', CE=>'X', 
                CLK=>clk_in_test_c, LSR=>'X', OFX1=>open, F1=>uut_DQ_31_N_77, 
                Q1=>open, OFX0=>open, F0=>uut_DQ_31_N_93, Q0=>DQ_31_N_3_23);
    uut_SLICE_15I: SLOGICB
      generic map (M0MUX=>"SIG", M1MUX=>"SIG", CLKMUX=>"INV", CEMUX=>"VHI", 
                   LSRMUX=>"SIG", CHECK_M1=>TRUE, CHECK_M0=>TRUE, 
                   CHECK_LSR=>TRUE)
      port map (M1=>DQ_test_out_25, FXA=>'X', FXB=>'X', A1=>'X', B1=>'X', 
                C1=>'X', D1=>'X', DI1=>'X', DI0=>'X', A0=>'X', B0=>'X', 
                C0=>'X', D0=>'X', M0=>DQ_test_out_24, CE=>'X', 
                CLK=>clk_in_test_c, LSR=>uut_DQ_31_N_77, OFX1=>open, F1=>open, 
                Q1=>DQ_31_N_3_25, OFX0=>open, F0=>open, Q0=>DQ_31_N_3_24);
    uut_SLICE_16I: SLOGICB
      generic map (M0MUX=>"SIG", M1MUX=>"SIG", CLKMUX=>"INV", CEMUX=>"VHI", 
                   LSRMUX=>"SIG", CHECK_M1=>TRUE, CHECK_M0=>TRUE, 
                   CHECK_LSR=>TRUE)
      port map (M1=>DQ_test_out_27, FXA=>'X', FXB=>'X', A1=>'X', B1=>'X', 
                C1=>'X', D1=>'X', DI1=>'X', DI0=>'X', A0=>'X', B0=>'X', 
                C0=>'X', D0=>'X', M0=>DQ_test_out_26, CE=>'X', 
                CLK=>clk_in_test_c, LSR=>uut_DQ_31_N_77, OFX1=>open, F1=>open, 
                Q1=>DQ_31_N_3_27, OFX0=>open, F0=>open, Q0=>DQ_31_N_3_26);
    uut_SLICE_17I: SLOGICB
      generic map (M0MUX=>"SIG", CLKMUX=>"INV", CEMUX=>"VHI", LSRMUX=>"SIG", 
                   CHECK_M0=>TRUE, CHECK_LSR=>TRUE)
      port map (M1=>'X', FXA=>'X', FXB=>'X', A1=>'X', B1=>'X', C1=>'X', 
                D1=>'X', DI1=>'X', DI0=>'X', A0=>'X', B0=>'X', C0=>'X', 
                D0=>'X', M0=>DQ_test_out_28, CE=>'X', CLK=>clk_in_test_c, 
                LSR=>uut_DQ_31_N_77, OFX1=>open, F1=>open, Q1=>open, 
                OFX0=>open, F0=>open, Q0=>DQ_31_N_3_28);
    uut_SLICE_18I: SLOGICB
      generic map (CLKMUX=>"INV", CEMUX=>"VHI", SRMODE=>"ASYNC", 
                   LUT0_INITVAL=>X"DFD0", LUT1_INITVAL=>X"DFD0", 
                   REG1_SD=>"VHI", REG0_SD=>"VHI", CHECK_DI1=>TRUE, 
                   CHECK_DI0=>TRUE)
      port map (M1=>'X', FXA=>'X', FXB=>'X', A1=>uut_n444, B1=>uut_n446, 
                C1=>uut_DQ_31_N_77, D1=>DQ_test_out_30, DI1=>uut_DQ_31_N_86, 
                DI0=>uut_DQ_31_N_87, A0=>uut_n444, B0=>uut_n446, 
                C0=>uut_DQ_31_N_77, D0=>DQ_test_out_29, M0=>'X', CE=>'X', 
                CLK=>clk_in_test_c, LSR=>'X', OFX1=>open, F1=>uut_DQ_31_N_86, 
                Q1=>DQ_31_N_3_30, OFX0=>open, F0=>uut_DQ_31_N_87, 
                Q0=>DQ_31_N_3_29);
    uut_SLICE_19I: SLOGICB
      generic map (CLKMUX=>"INV", CEMUX=>"VHI", SRMODE=>"ASYNC", 
                   LUT0_INITVAL=>X"DFD0", LUT1_INITVAL=>X"FEFE", 
                   REG0_SD=>"VHI", CHECK_DI0=>TRUE)
      port map (M1=>'X', FXA=>'X', FXB=>'X', A1=>uut_byte_counter_2, 
                B1=>uut_byte_counter_1, C1=>uut_byte_counter_0, D1=>'X', 
                DI1=>'X', DI0=>uut_DQ_31_N_72, A0=>uut_n444, B0=>uut_n446, 
                C0=>uut_DQ_31_N_77, D0=>DQ_test_out_31, M0=>'X', CE=>'X', 
                CLK=>clk_in_test_c, LSR=>'X', OFX1=>open, F1=>uut_n444, 
                Q1=>open, OFX0=>open, F0=>uut_DQ_31_N_72, Q0=>DQ_31_N_3_31);
    SLICE_20I: SLOGICB
      generic map (CLKMUX=>"SIG", CEMUX=>"VHI", SRMODE=>"ASYNC", 
                   LUT0_INITVAL=>X"5555", REG0_SD=>"VHI", CHECK_DI0=>TRUE)
      port map (M1=>'X', FXA=>'X', FXB=>'X', A1=>'X', B1=>'X', C1=>'X', 
                D1=>'X', DI1=>'X', DI0=>CK_LVDS_N_123, A0=>clk_ram, B0=>'X', 
                C0=>'X', D0=>'X', M0=>'X', CE=>'X', CLK=>clk_in_test_c, 
                LSR=>'X', OFX1=>open, F1=>open, Q1=>open, OFX0=>open, 
                F0=>CK_LVDS_N_123, Q0=>clk_ram);
    SLICE_21I: SLOGICB
      generic map (CLKMUX=>"INV", CEMUX=>"VHI", LSRMUX=>"SIG", 
                   ...
                   CHECK_LSR=>TRUE)
      port map (M1=>'X', FXA=>'X', FXB=>'X', A1=>'X', B1=>'X', C1=>'X', 
                D1=>'X', DI1=>'X', DI0=>n448, A0=>'X', B0=>'X', C0=>'X', 
                D0=>'X', M0=>'X', CE=>'X', CLK=>state, LSR=>state, OFX1=>open, 
                F1=>open, Q1=>open, OFX0=>open, F0=>n448, Q0=>estado_test_c);
    uut_SLICE_22I: SLOGICB
      ...
      port map (M1=>'X', FXA=>'X', FXB=>'X', A1=>'X', B1=>'X', C1=>'X', 
                ...
                C0=>'X', D0=>'X', M0=>'X', CE=>uut_state_N_81, 
                CLK=>clk_in_test_c, LSR=>'X', OFX1=>open, F1=>open, Q1=>open, 
                OFX0=>open, F0=>VCC_net_000_BUF1, Q0=>state);
    uut_SLICE_23I: SLOGICB
      generic map (CLKMUX=>"INV", CEMUX=>"SIG", SRMODE=>"ASYNC", 
                   LUT0_INITVAL=>X"F7F7", LUT1_INITVAL=>X"070F", 
                   REG0_SD=>"VHI", CHECK_DI0=>TRUE, CHECK_CE=>TRUE)
      port map (M1=>'X', FXA=>'X', FXB=>'X', A1=>uut_n444, B1=>uut_n446, 
                C1=>state, D1=>uut_n447, DI1=>'X', DI0=>uut_n447, 
                A0=>uut_byte_counter_2, B0=>uut_byte_counter_1, 
                C0=>uut_byte_counter_0, D0=>'X', M0=>'X', CE=>uut_DQ_31_N_77, 
                CLK=>clk_in_test_c, LSR=>'X', OFX1=>open, 
                F1=>uut_clk_system_N_71_enable_3, Q1=>open, OFX0=>open, 
                F0=>uut_n447, Q0=>uut_DQ_4_N_58);
    uut_SLICE_24I: SLOGICB
      generic map (CLKMUX=>"INV", CEMUX=>"SIG", LSRMUX=>"SIG", 
                   LUT0_INITVAL=>X"0707", LUT1_INITVAL=>X"5252", 
                   REG1_SD=>"VHI", REG0_SD=>"VHI", CHECK_DI1=>TRUE, 
                   CHECK_DI0=>TRUE, CHECK_CE=>TRUE, CHECK_LSR=>TRUE)
      port map (M1=>'X', FXA=>'X', FXB=>'X', A1=>uut_byte_counter_1, 
                B1=>uut_byte_counter_2, C1=>uut_byte_counter_0, D1=>'X', 
                DI1=>uut_n392, DI0=>uut_n350, A0=>uut_byte_counter_1, 
                B0=>uut_byte_counter_2, C0=>uut_byte_counter_0, D0=>'X', 
                M0=>'X', CE=>uut_clk_system_N_71_enable_3, CLK=>clk_in_test_c, 
                LSR=>uut_n262, OFX1=>open, F1=>uut_n392, 
                Q1=>uut_byte_counter_1, OFX0=>open, F0=>uut_n350, 
                Q0=>uut_byte_counter_0);
    uut_SLICE_25I: SLOGICB
      generic map (CLKMUX=>"INV", CEMUX=>"SIG", LSRMUX=>"SIG", 
                   LUT0_INITVAL=>X"6464", REG0_SD=>"VHI", CHECK_DI0=>TRUE, 
                   CHECK_CE=>TRUE, CHECK_LSR=>TRUE)
      port map (M1=>'X', FXA=>'X', FXB=>'X', A1=>'X', B1=>'X', C1=>'X', 
                D1=>'X', DI1=>'X', DI0=>uut_n358, A0=>uut_byte_counter_1, 
                B0=>uut_byte_counter_2, C0=>uut_byte_counter_0, D0=>'X', 
                M0=>'X', CE=>uut_clk_system_N_71_enable_3, CLK=>clk_in_test_c, 
                LSR=>uut_n262, OFX1=>open, F1=>open, Q1=>open, OFX0=>open, 
                F0=>uut_n358, Q0=>uut_byte_counter_2);
    uut_SLICE_26I: SLOGICB
      generic map (LUT0_INITVAL=>X"FF08", LUT1_INITVAL=>X"0200")
      port map (M1=>'X', FXA=>'X', FXB=>'X', A1=>uut_byte_counter_2, B1=>state, 
                C1=>uut_byte_counter_0, D1=>uut_byte_counter_1, DI1=>'X', 
                DI0=>'X', A0=>uut_byte_counter_2, B0=>uut_byte_counter_1, 
                C0=>uut_byte_counter_0, D0=>state, M0=>'X', CE=>'X', CLK=>'X', 
                LSR=>'X', OFX1=>open, F1=>uut_n262, Q1=>open, OFX0=>open, 
                F0=>uut_state_N_81, Q0=>open);
    SLICE_27I: SLOGICB
      generic map (LUT0_INITVAL=>X"EEEC")
      port map (M1=>'X', FXA=>'X', FXB=>'X', A1=>'X', B1=>'X', C1=>'X', 
                D1=>'X', DI1=>'X', DI0=>'X', A0=>CS_n_test_c, B0=>reset_test_c, 
                C0=>state, D0=>clk_ram, M0=>'X', CE=>'X', CLK=>'X', LSR=>'X', 
                OFX1=>open, F1=>open, Q1=>open, OFX0=>open, F0=>CS_n_test_c, 
                Q0=>open);
    DQ_test_30_I: DQ_test_30_B
      port map (PADDI=>DQ_test_out_30, PADDO=>DQ_31_N_3_30, 
                PADDT=>uut_DQ_4_N_58, DQtest30=>DQ_test(30));
    DQ_test_4_I: DQ_test_4_B
      port map (PADDI=>DQ_test_out_4, PADDO=>DQ_31_N_3_4, PADDT=>uut_DQ_4_N_58, 
                DQtest4=>DQ_test(4));
    DQ_test_5_I: DQ_test_5_B
      port map (PADDI=>DQ_test_out_5, PADDO=>DQ_31_N_3_5, PADDT=>uut_DQ_4_N_58, 
                DQtest5=>DQ_test(5));
    DQ_test_6_I: DQ_test_6_B
      port map (PADDI=>DQ_test_out_6, PADDO=>DQ_31_N_3_6, PADDT=>uut_DQ_4_N_58, 
                DQtest6=>DQ_test(6));
    DQ_test_7_I: DQ_test_7_B
      port map (PADDI=>DQ_test_out_7, PADDO=>DQ_31_N_3_7, PADDT=>uut_DQ_4_N_58, 
                DQtest7=>DQ_test(7));
    DQ_test_8_I: DQ_test_8_B
      port map (PADDI=>DQ_test_out_8, PADDO=>DQ_31_N_3_8, PADDT=>uut_DQ_4_N_58, 
                DQtest8=>DQ_test(8));
    DQ_test_9_I: DQ_test_9_B
      port map (PADDI=>DQ_test_out_9, PADDO=>DQ_31_N_3_9, PADDT=>uut_DQ_4_N_58, 
                DQtest9=>DQ_test(9));
    DQ_test_10_I: DQ_test_10_B
      port map (PADDI=>DQ_test_out_10, PADDO=>DQ_31_N_3_10, 
                PADDT=>uut_DQ_4_N_58, DQtest10=>DQ_test(10));
    DQ_test_11_I: DQ_test_11_B
      port map (PADDI=>DQ_test_out_11, PADDO=>DQ_31_N_3_11, 
                PADDT=>uut_DQ_4_N_58, DQtest11=>DQ_test(11));
    ...
    DQ_test_12_I: DQ_test_12_B
      port map (PADDI=>DQ_test_out_12, PADDO=>DQ_31_N_3_12, 
                PADDT=>uut_DQ_4_N_58, DQtest12=>DQ_test(12));
    ...
    DQ_test_13_I: DQ_test_13_B
      port map (PADDI=>DQ_test_out_13, PADDO=>DQ_31_N_3_13, 
                PADDT=>uut_DQ_4_N_58, DQtest13=>DQ_test(13));
